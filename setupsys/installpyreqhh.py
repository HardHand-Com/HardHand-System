...
def check_python_packages():
    ...
    required_packages = ["flask", "flask_sqlalchemy", "flask_bcrypt", "bson", "pymongo", "flask_login", "requests"]
...
print("Checking if required Python packages are installed in venv 'hhsystem'")
